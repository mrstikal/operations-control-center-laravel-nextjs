...
type ContractIncidentEditModalProps = {
  isOpen: boolean;
  loading: boolean;
  formData: {
    title: string;
  ...
  onCloseAction: () => void;
  onSubmitAction: () => void;
  onFormChangeAction: (data: Partial<ContractIncidentEditModalProps["formData"]>) => void;
};
...
export default function ContractIncidentEditModal({
  isOpen,
  loading,
  formData,
  onCloseAction,
  onSubmitAction,
  onFormChangeAction,
}: ContractIncidentEditModalProps) {
